...
//			Core.rectangle(frame, facesArray[i].tl(), facesArray[i].br(), new Scalar(0, 255, 0, 255), 3);
	...
	protected void haarSelected() {
		...
		this.checkboxSelection("/home/tao_thao/Documents/workspace-sts-3.9.9.RELEASE/FaceDetection/opencv/data/haarcascades/haarcascade_eye.xml");
	}

	/**
	 *
	 * When the LBP checkbox is selected, deselect the other one and load the proper
	 * XML classifier
	 */
	@FXML
	protected void lbpSelected() {
		...
		this.checkboxSelection("/home/tao_thao/Documents/workspace-sts-3.9.9.RELEASE/FaceDetection/opencv/data/lbpcascades/lbpcascade_frontalface.xml");
	}
